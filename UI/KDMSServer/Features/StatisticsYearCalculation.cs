...
{
    public class StatisticsYearCalculation
    {
        ...
        public class CommandHandler : IRequestHandler<Command, Response>
        {
            ...
            public async Task<Response> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    var datas = _commonData.StatisticsMonthDataLoad(request.Time);
                    if (datas != null && datas.Count > 0)
                    {
                        List<StatisticsYear> dataList = new List<StatisticsYear>();
                        ...
                        if (dataList.Count > 0)
                            _commonData.StatisticsYearDataInput(dataList);

...
{
    public class GetFiAlarmData
    {
        public class Command : BaseRequest, IRequest<Response>
        {
        }

        public class Response : FiAlarmDataResponseModel
        {
        ...
        public class CommandHandler : IRequestHandler<Command, Response>
        {
            ...
            public async Task<Response> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    var datas = _commonData.FiDataLoad(request.CeqList, request.FromDate, request.ToDate);
